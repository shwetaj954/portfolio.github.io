...
<div class="row" style="background-color: while;">
       <div class="col-12">
           <h2 style="color:#422f3e;">Summary</h2>
...
<section id="skillssection">
     ...
     <div class="row" style="background-color: while;margin:0;padding:0;">
       <div class="col-12">
           <h2 style="color:#422f3e">Skills & Hobbies</h2>
